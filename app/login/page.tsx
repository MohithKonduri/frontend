...
import { Leaf, Lock, User, ArrowRight, Sprout, Tractor } from "lucide-react"
            ...
            <Card className="w-full max-w-md relative z-10 border-white/10 bg-black/40 backdrop-blur-xl shadow-2xl ring-1 ring-white/10">
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-2">
                        <Label htmlFor="username" className="text-gray-200 font-medium ml-1">Username / Email</Label>
                ...
                <CardFooter className="flex flex-col gap-4 pt-4">
                    <Button className="w-full h-11 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white font-semibold shadow-lg shadow-green-900/20 transition-all duration-300 transform hover:scale-[1.01] hover:shadow-green-500/20 border border-green-500/20 cursor-pointer">
